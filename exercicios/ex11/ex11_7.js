...
let TH = Number(prompt('Você ganha quantos por horas?: '))
let TM = Number(prompt('Você  ganha quantos por mês?: '))

let salario = TH * TM
let IR = salario * 0.11
let INSS = salario * 0.88
let sindicato = salario * 0.05
let dc = IR + INSS + sindicato
let sL = salario - dc
console.log(`Salario Bruto R$ ${salario}`)
console.log(`IR R$ ${IR}`)
console.log(`INSS R$ ${INSS}`)
console.log(`Salario Liquido R$ ${sL}`)